        ...
        <div  class='note-width form-note-margin-left note-margin-left' id='note_container'  style='width: 90%;'>
            <div  style='z-index:-1;'>
                <div class=' '  >
                    ...
                    <span id = 'note_text' style='display: inline-block; position: relative; top: 20px; width: 90%;'   class='note-content form-control m-2 border border-success' placeholder='Text' required contentEditable='true'>
                        
                    </span>

                    <div id='additional_data' notenumber = '".$notenumber."' category_id='".$note->getFK_CategoryID()."'></div>
                </div>
            </div>
    <!--</form>-->
